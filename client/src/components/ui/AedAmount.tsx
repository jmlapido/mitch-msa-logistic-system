...
function DirhamSign() {
  return (
    <svg
      ...
      aria-hidden="true"
      style={{ display: 'inline-block', width: '0.85em', height: '0.74em', verticalAlign: '-0.05em', flexShrink: 0 }}
      fill="currentColor"
    >
...
export function AedAmount({ amount, className }: { amount: number; className?: string }) {
  ...
  return (
    <span className={cn('inline-flex items-baseline gap-[0.2em]', className)}>
      <DirhamSign />
      {num}
    </span>
  );
