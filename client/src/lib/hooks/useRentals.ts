...
export type Tenant = { id: number; name: string; phone?: string; email?: string; id_number?: string; notes?: string; unit_id?: number; lease_id?: number; unit_no?: string; building_name?: string; lease_status?: string; end_date?: string; annual_rent?: number; monthly_rent?: number; payment_frequency?: 'monthly' | 'annual' | null; total_balance?: number };
